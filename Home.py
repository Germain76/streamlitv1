...
<div class="root-div">
	<div class="left-div">
		 <img src="https://source.unsplash.com/hpjSkU2UYSU" alt="Image de courverture" height=100% class="cover-image">
	</div>
	<div class="right-div">
		<h1 class="main-title">Challenge Rakuten</h1>
		<div class="divider"></div>
		<h4 class="promotion">Promotion Data Scientist Bootcamp Septembre 2023</h4>
		<h3 class="names">CLAUDE Germain — DOYON Mathis<br>M'BALI Guillaume — TOUAZI Rabah</h3>
